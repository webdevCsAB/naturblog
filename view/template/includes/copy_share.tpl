...
<div>
  ...
  <a title="<?php echo txt('ttl_button_share'); ?>..." href="https://www.addtoany.com/share#url=<?php echo urlencode($copy_link); ?>&amp;title=<?php echo rawurlencode($render["page"]["title"].' | '.BLOG_NAME); ?>" class="btn hidden-print" target="_blank">+&nbsp;<?php echo txt('lbl_button_share'); ?></a>
